...
export default function ContextView() {
  const [activeStratum, setActiveStratum] = useState<string>("indios");
  ...
  const socialStrata = {
    peninsulares: {
      ...
      privileges:
        "Held the highest offices in administration, church, and military. Exempt from tribute and forced labor.",
      politicalInfluence:
        "Absolute authority. Dominated the Real Audiencia (Supreme Court) and clerical archdioceses.",
      historicalQuote:
        '"They looked upon the colony as a gold mine to be exploited, and the natives as subhuman servants."',
    },
    insulares: {
      title: "Insulares (Creoles)",
      subtitle: "Pure-blooded Spaniards born in the Philippines",
      privileges:
        "Enjoyed high social rank, owned large agricultural land, and dominated local businesses.",
      politicalInfluence:
        "Moderate authority. Held lower governor positions and secondary military ranks; envied the Peninsulares' supreme status.",
      historicalQuote:
        '"They are Spanish in blood, but colonial in heart, stuck in a political purgatory."',
    },
    mestizos: {
      title: "Mestizos (Spanish & Chinese)",
      subtitle: "People of mixed native and Spanish or Chinese ancestry",
      privileges:
        "Dominant mercantile class, managed trade, highly educated (Ilustrados), fluent in Spanish.",
      politicalInfluence:
        "Rising financial power, but politically marginalized by pure Spaniards. Formed the intellectual nucleus of reform.",
      historicalQuote:
        '"By combining local resilience with Chinese commercial wits, they became the cashbox of Manila."',
    },
    indios: {
      title: "Indios (Native Filipinos)",
      subtitle: "The indigenous Austronesian masses",
      privileges:
        "Exempt from nothing. Subjected to heavy taxes, Polo y Servicios (40 days of annual forced labor), and extreme social abuse.",
      politicalInfluence:
        "Zero political representation. Governed through fear and local friar surveillance.",
      historicalQuote:
        '"The true tillers of the soil, labeled ignorant, yet they carried the entire weight of the colony on their backs."',
    },
  };
      ...
      >
        ...
        >
          ...
          <p className="font-serif italic text-xs md:text-sm text-gold-300/80 mt-1">
            Examing the socio-political conditions of Spanish Manila and the
            legal mandate of memory.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="lg:col-span-7 space-y-6" id="society-column">
          ...
          <p className="text-sm text-amber-950/80 leading-relaxed text-justify">
            During the 19th century, Spain was a declining empire plagued by
            domestic civil war and political instability. In the Philippine
            colony, this manifested as corrupt, arbitrary governance overseen by
            the local Catholic Friars—the <strong>Frailocracia</strong>. While
            physical trade boomed due to the opening of the Suez Canal, social
            conditions deteriorated. Native Filipinos were treated as subhuman
            under a strict, race-based caste system.
          </p>

          {/* Interactive Strata Pyramid */}
          <div
            className="p-6 bg-gold-50/40 border border-gold-300/35 rounded-sm space-y-6"
            id="strata-pyramid-container"
          >
            ...
            <div
              className="max-w-md mx-auto flex flex-col items-center space-y-1.5"
              id="pyramid-graphic"
            >
              {/* Peninsulares */}
              <button
              ...
              {/* Indios */}
              <button
                onClick={() => setActiveStratum("indios")}
                className={`w-full py-2 text-[10px] md:text-xs font-display font-bold tracking-wider rounded-b-sm border transition-all duration-300 ${activeStratum === "indios" ? "bg-crimson-850 text-gold-100 border-gold-400 scale-105 shadow-md" : "bg-faf6ee text-crimson-950 border-gold-300/50 hover:bg-gold-100/50"}`}
                id="pyramid-indio"
              >
                Indios (The Masses)
              </button>
            ...
            <div
              className="p-4 bg-faf6ee border border-dashed border-gold-600/25 rounded-xs space-y-2 text-sm"
              id="stratum-panel"
            >
              <div className="flex justify-between items-center border-b border-gold-300/30 pb-1">
                <span className="font-serif text-base font-bold text-crimson-900">
                  {
                    socialStrata[activeStratum as keyof typeof socialStrata]
                      .title
                  }
                </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 text-xs">
                <div>
                  <span className="font-bold text-[10px] text-crimson-950 uppercase tracking-wider block">
                    Privileges & Taxes:
                  </span>
                  <p className="text-amber-950/80 mt-1">
                    {
                      socialStrata[activeStratum as keyof typeof socialStrata]
                        .privileges
                    }
        ...
        <div className="lg:col-span-5" id="law-column">
          <ParchmentCard
            title="Republic Act 1425"
            subtitle="The Mandate of Remembrance"
            headerBadge="THE RIZAL LAW"
            doubleBorder
            ornament
          >
            <div className="space-y-4 text-xs md:text-sm text-amber-950/90">
              ...
              <p className="text-justify leading-relaxed">
                Authored by Senator Claro M. Recto and signed into law by
                President Ramon Magsaysay,{" "}
                <strong>Republic Act No. 1425</strong> remains one of the most
                controversial educational mandates in Philippine history.
              </p>

              <h4 className="font-serif font-bold text-sm text-crimson-950 mt-4">
                The Clashing Factions:
              </h4>
              <p className="text-justify leading-relaxed">
                The Catholic Church and sectarian groups fiercely opposed the
                bill. They argued that Rizal’s novels, <em>Noli Me Tangere</em>{" "}
                and <em>El Filibusterismo</em>, contained severe anti-clerical
                passages that would ruin the faith of Catholic students. Recto
                countered that the objective was not to attack the church, but
                to awaken a sleeping national spirit.
              </p>
              ...
              <ul className="list-disc list-inside space-y-1 pl-2 text-justify">
                <li>
                  To rededicate the lives of the youth to the ideals of freedom
                  and nationalism.
                </li>
                <li>
                  To pay tribute to our national hero for shaping the Filipino
                  character.
                </li>
                <li>
                  To gain inspiring sources of patriotism through the study of
                  his literature.
                </li>
              </ul>
